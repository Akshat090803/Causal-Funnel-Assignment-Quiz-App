...
const Header = () => {
  ...
  useEffect(() => {
    console.log("Tagline:", taglineWords[taglineIndex]);
  }, [taglineIndex]);

  return (
    <header className="min-h-12 z-40 py-2 flex justify-between items-center px-10 shadow-sm border-b">
      <h1 onClick={()=>navigate('/')} className="text-2xl font-bold bg-clip-text text-transparent bg-linear-to-b from-foreground from-60% to-[#999] cursor-pointer">Quizio</h1>
